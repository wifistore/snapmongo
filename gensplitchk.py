...
def gencrchk():
  ...
  cmd5 = "time mongo "+mongostarget+"/admin -uadmin -p\""+mongoadminpwd+"\" ./mv1.js\n"
  cmd6 = "time mongo "+mongostarget+"/admin -uadmin -p\""+mongoadminpwd+"\" ./mv2.js\n"
  cmd7 = "time mongo "+mongostarget+"/admin -uadmin -p\""+mongoadminpwd+"\" ./mv3.js\n"
  cmd8 = "time mongo "+mongostarget+"/admin -uadmin -p\""+mongoadminpwd+"\" ./mv4.js\n"
